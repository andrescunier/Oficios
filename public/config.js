/**
 * Runtime Configuration — DIAP Store
 * Loaded before the app boots so window.__APP_CONFIG__ is available immediately.
    ...
    categories: [
      {
        ...
        searchTerms: ["ssd", "sata", "disco", "almacenamiento"]
      },
      {
        name: "Memoria RAM",
        ...
        slug: "memoria-ram",
        group: "Memoria",
        searchTerms: ["ram", "ddr4", "ddr5", "memoria"]
      }
    ],
    placeholders: {
