...
const paymentMethodsSchema = z.object({
  ...
  prestamo: z.boolean().optional(),
});

const loanTermSchema = z.object({
  months: z.number(),
  label: z.string().optional(),
...
const loanSchema = z.object({
  ...
  monthlyRate: z.number().optional(),
  originationFeeRate: z.number().optional(),
  terms: z.array(loanTermSchema).optional(),
}).partial();
...
const runtimeConfigSchema = z.object({
  ...
  ui: z.object({
    ...
    paymentMethodLoan: z.string().optional(),
    ...
    ordersDetailLoanStatusLabel: z.string().optional(),
    ordersDetailLoanNumberLabel: z.string().optional(),
    ordersDetailLoanPrincipalLabel: z.string().optional(),
    ordersDetailLoanPaidLabel: z.string().optional(),
    ordersDetailLoanOutstandingLabel: z.string().optional(),
    ordersDetailLoanDueDateLabel: z.string().optional(),
    ordersDetailLoanPaymentsTitle: z.string().optional(),
    ordersDetailLoanNoPaymentsMessage: z.string().optional(),
    loanStatusActive: z.string().optional(),
    loanStatusPaid: z.string().optional(),
    loanStatusPending: z.string().optional(),
    loanStatusCancelled: z.string().optional(),
