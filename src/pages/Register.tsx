...
// Schema will be built dynamically based on runtime registration config
...
export const Register: React.FC = () => {
  ...
  // Build zod schema dynamically based on visible fields + validation config
  ...
  // Validaciones de contraseña en tiempo real (driven por validation config)
  ...
  const onSubmit = async (data: RegisterFormData) => {
    try {
      ...
      addNotification({
        type: 'success',
        title: uiConfig.registerSuccessTitle,
        message: validationCfg.messages.registerSuccessMessage,
      });
    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/50 px-4 py-8">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">{registrationConfig.title}</CardTitle>
          <CardDescription>
        ...
        <CardContent>
            ...
            <Button type="submit" className="w-full" disabled={isLoading}>
              {isLoading ? (
                ...
                <>
                  ...
                  {registrationConfig.submitLabel}
                </>
              )}
            </Button>
          </form>
          ...
          <div className="mt-6 text-center text-sm">
            <span className="text-muted-foreground">{registrationConfig.alreadyHaveAccountText} </span>
            <Link to="/login" className="text-primary hover:underline">
              {registrationConfig.alreadyHaveAccountLinkText}
            </Link>
          </div>
        </CardContent>
      </Card>
